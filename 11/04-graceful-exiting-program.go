// Example copied from https://callistaenterprise.se/blogg/teknik/2019/10/05/go-worker-cancellation/
package main
...
// Producer simulates an external library that invokes the registered callback when it has new data for us once per 100ms.
